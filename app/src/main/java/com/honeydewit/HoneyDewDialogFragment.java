...
public class HoneyDewDialogFragment extends DialogFragment {
	...
	public static HoneyDewDialogFragment newInstance() {
		HoneyDewDialogFragment frag = new HoneyDewDialogFragment();
