package com.honeydewit.calendar.fragments;
...
import com.honeydewit.adapters.ListEventInstancesAdapter;
...
public class DayFragment extends Fragment implements OnClickListener {
	...
	private List<EventInstance> getDailyEventsInstances(GregorianCalendar cal) {
		...
		SparseArray<LinkedList<EventInstance>> events = ((HoneyDewApplication)context.getApplicationContext()).getCalDbHelper().getMonthlyEventsInstances(this.getActivity(), 1, DateUtil.getBeginningOfDay(cal), DateUtil.getEndOfDay(cal));
