...
import com.honeydewit.calendar.customviews.CalendarView;
...
public class MonthFragment extends Fragment implements OnClickListener,	OnLongClickListener, OnDateSetListener {
	...
	private MonthlyEventInstances getMonthlyEvents() {
		return  ((HoneyDewApplication)getActivity().getApplicationContext()).getCalDbHelper().getMonthlyEventsInstances(
