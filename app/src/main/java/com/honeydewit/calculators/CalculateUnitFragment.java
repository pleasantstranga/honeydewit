...
public class CalculateUnitFragment extends android.app.Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		((HoneyDewApplication)getActivity().getApplicationContext()).loadBannerAd((AdView) rootView.findViewById(R.id.adView));
        subCategoryCode = getArguments().getInt(com.honeydewit.Constants.SUB_CAT_CODE);
       
        units = ((HoneyDewApplication)getActivity().getApplicationContext()).getShoppingListDbHelper().getUnitsOfMeasurements(subCategoryCode);
