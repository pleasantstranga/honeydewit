...
import com.honeydewit.calendar.EventActivity;
import com.honeydewit.calendar.EventInstance;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                deleteButton.setOnClickListener(new OneOffClickListener() {
					...
					public void onClick(View v) {
						...
						List<ListEvent> events = ((HoneyDewApplication)context.getApplicationContext()).getShoppingListDbHelper().getListEvents(instance.getEvent().getCalendarId(), instance.getEvent().getEventId());
							...
							dialog.setPositiveButton(getContext().getText(R.string.ok).toString(), new View.OnClickListener() {
								...
								public void onClick(View v) {
									try {
										...
										((HoneyDewApplication) context.getApplicationContext()).getCalDbHelper().addUpdateCalendarEvent(context, instance.getEvent());
									} catch (Exception e) {
										e.printStackTrace();
									} finally {
										remove(instance);
