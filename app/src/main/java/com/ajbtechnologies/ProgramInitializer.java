...
public class ProgramInitializer extends OrmLiteSqliteOpenHelper {
	...
	private static void initNotesList(Application context) throws Exception {
    ...
    private static void initializeConversionDb(Application context) throws Exception {
    ...
    private static void initDbHelpers(Application context) throws Exception {
    ...
    private static void initExportTempDirectory(Application context) throws Exception {
