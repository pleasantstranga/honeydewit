...
import com.ajbtechnologies.Reminder;
...
import com.ajbtechnologies.validate.EventValidator;
...
public class EventActivity extends BasicActivity {
	...
	private Map<String, com.ajbtechnologies.pojos.Calendar> calendarMap;
	...
	private String getDefaultCalendar() {
		...
		for(com.ajbtechnologies.pojos.Calendar calendar: calendarMap.values()) {
			if(index == 0) {
